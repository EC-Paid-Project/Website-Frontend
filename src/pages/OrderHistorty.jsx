              ...
              >
                <div className="order-history__item-content">
                  <div className="order-history__item-info">
                    <span className="order-history__item-id">Order ID: {order.id}</span>
                    <span className="order-history__item-status">Status: {order.status}</span>
                  </div>
                  <div className="order-history__item-qty">Qty: {order.totalItemsQty}</div>
                </div>
              </li>
            ))}
          </ul>
